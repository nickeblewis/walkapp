...
class Footer extends React.Component {
  render() {
    return (
      <footer className="footer">
        <div className="container">
          <div className="columns">
            <div className="column is-third">
              <ul>
                <li>Social</li>
                <li><a href="https://facebook.com/farnboroughguide" target="_blank">Facebook</a></li>
                <li><a href="https://twitter.com/fboroguide" target="_blank">Twitter</a></li>
                <li><a href="https://www.instagram.com/farnboroughguide/?hl=en" target="_blank">Instagram</a></li>
              </ul>
            </div>
            <div className="column is-third">
              <ul>
        ...
        {/* <a className="link near-white hover-silver dib h2 w2 mr3" href="https://facebook.com/farnboroughguide" title="Facebook">
  ...
  <a className="link hover-silver near-white dib h2 w2 mr3" href="https://www.instagram.com/farnboroughguide/?hl=en" title="Instagram">
  ...
  <a className="link hover-silver near-white dib h2 w2 mr3" href="https://twitter.com/fboroguide" title="Twitter">
